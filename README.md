...
flowchart TD
    ...
    %% 스타일 정의
    classDef home fill:#F6F8FA,color:#333,stroke:#D1D9E0,stroke-width:2px, padding:10px;
    classDef list fill:#F6F8FA,color:#333,stroke:#D1D9E0,stroke-width:2px, padding:10px;
    classDef detail fill:#F6F8FA,color:#333,stroke:#D1D9E0,stroke-width:2px, padding:10px;
    classDef action fill:#F6F8FA,color:#333,stroke:#D1D9E0,stroke-width:2px, padding:10px;
